    ...
    public partial class createmenutable : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.menus", t => t.id_menu)
                .Index(t => t.id_menu);
                ...
                c => new
                    {
                        ...
                        name_menu = c.String(nullable: false, maxLength: 100),
                        created_at = c.DateTime(),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        email_mes = c.String(nullable: false, maxLength: 200, unicode: false),
                        content_mes = c.String(nullable: false, storeType: "ntext"),
                        id_mes = c.Int(),
                        fullname_mes = c.String(maxLength: 100, unicode: false),
                    })
                .PrimaryKey(t => new { t.email_mes, t.content_mes });
